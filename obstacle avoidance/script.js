...
function moveWall()
{
    ...
    var a = parseInt(avoided/7);
    var c = parseInt(crash/7);
    var s = parseInt(successRate);
    document.getElementById('avoided').value="Avoided" + " " + a ;
    document.getElementById('collision').value="Collision" + "  " + c ;
    document.getElementById('success').value="Success:" + s + "% ";
